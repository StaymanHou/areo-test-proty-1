...
stage: wbs
state: in-progress
updated: 2026-05-16 (WP14.8 DONE — Score function + Nelder-Mead optimizer + tune CLI shipped as commit f2fcc36; D14 cascade step 3 of 3 complete; `npm run tune` is the new physics-mechanism tuning entry per CLAUDE.md rule #3. Cascade fully landed: WP14.6 ✓ → WP14.7 ✓ → WP14.8 ✓ → rescoped WP14.5-retry is now genuinely unblocked. SURFACE-2026-05-16-03 logged (arch.md §D14.4 NaN-penalty sign-typo, doc-fix only).)
---
