# arch.md D10-D27 cascade — archive extract

**Source:** `docs/product/arch.md` lines 133-2645 (as of 2026-06-06)
**Extracted:** 2026-06-06 by task `arch-wbs-size-guard-archive` (SURFACE-2026-06-06-08)
**Scope:** All architect-cycle Revision sections from 2026-05-11 (D10) through 2026-05-25 evening (D27). The D14→D27 cascade is the bulk; D10/D11/D12/D13 + D15/D16/D17/D18 are the pre-cascade mechanism-layer ancestors that fed into it.

The live `docs/product/arch.md` retains the durable core (Tech Stack, System Design, Key Decisions D1-D14 summary, forward-compat notes) plus one-line summary stubs for each Revision below. The full prose is preserved here verbatim with no editorial changes; line numbers in the original may have shifted since extraction.
