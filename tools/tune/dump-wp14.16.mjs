// WP14.16 — dump symmetric-mirror CSVs at the WP14.16 globalBest knobs (D21 score function).
// Reads globalBest from tools/tune/results/wp14.16-d22-tune.json and emits CSVs to /tmp/wp14.16.
...
const OUT_DIR = '/tmp/wp14.16';
fs.mkdirSync(OUT_DIR, { recursive: true });

const results = JSON.parse(fs.readFileSync('/Users/stayman/Tmp/test-proj/tools/tune/results/wp14.16-d22-tune.json', 'utf8'));
...
console.log('=== WP14.16 globalBest (symmetric-mirror via explicit surfaces.1.* expansion) ===');
