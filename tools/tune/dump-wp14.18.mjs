// WP14.18 — dump symmetric-mirror CSVs at the WP14.18 globalBest knobs (D23-γ-evolved score function).
// Reads globalBest from tools/tune/results/wp14.18-d23-tune.json and emits CSVs to /tmp/wp14.18.
...
const OUT_DIR = '/tmp/wp14.18';
fs.mkdirSync(OUT_DIR, { recursive: true });

const results = JSON.parse(fs.readFileSync('/Users/stayman/Tmp/test-proj/tools/tune/results/wp14.18-d23-tune.json', 'utf8'));
...
console.log('=== WP14.18 globalBest (symmetric-mirror via explicit surfaces.1.* expansion) ===');
