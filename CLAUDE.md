...
**Status (2026-05-16, post-WP14.5-retry):** Phase 1 closed (WP1–WP9.6, 246/246 Vitest + 1/1 Playwright). Phase 2 progress: WP10/10.5/11/12/13/14 shipped 2026-05-12 (two mission types playable). D14 cascade landed: WP14.6 ✓ (physics-core extraction + parity test), WP14.7 ✓ (Node Rapier-WASM harness), WP14.8 ✓ (score function + Nelder-Mead optimizer + `npm run tune` CLI), **WP14.5-retry ✓ (joint optimizer search; shipped as commit `5fa06d1`)**. WP14.5-retry's joint 4D (clQ, clAlphaDot) search over 8 distinct parameter points all hit NaN floor; regression Hessian degenerate; baseline aircraft.json itself NaN's in high-throttle at tick 417. **Outcome: escalation — filed SURFACE-2026-05-16-04** as the consolidated mechanism-revision driver. Recommended fix per evidence: Option A on both mechanisms (implicit-Euler form for β4; non-dimensional `cl_α̇ · c̄ / (2V)` for β5). The harness cascade's empirical infrastructure now exists for the upcoming D15/D16 arch revision: `npm run tune` for parameter searches, `tools/tune/probe-baseline.mjs` for hand-picked sampling, `tools/tune/dump-trajectories.mjs` for per-regime CSV evidence. Tally: 516/516 Vitest + 12/12 Playwright (3 phugoid-probe specs intentionally skipped) + tsc strict (both configs) + build clean — matches pre-WP14.5-retry baseline (no production code changed; this WP's deliverable was empirical evidence, not parameter selection). **Next:** D15+D16 arch-revision cascade via `/product-arch` (analogous to D14 for β5; β4 implicit-Euler + β5 non-dim form), then WP14.5-retry-2 (or equivalent) once both schemas land. Phase 2 mission content (WP15 takeoff/landing, WP16 combat) remains paused at post-WP14 line. Open SURFACE items: SURFACE-2026-05-16-04 (high — *the* arch-revision driver; supersedes -12-03 + -16-01 as actionable); SURFACE-2026-05-12-03 + SURFACE-2026-05-16-01 (high — open as origin records, superseded by -16-04); SURFACE-2026-05-12-01 (medium — blocked-by -16-04); SURFACE-2026-05-11-04 (partial — tuning side via cascade); SURFACE-2026-05-11-02 (medium); SURFACE-2026-05-16-03 (low — arch.md doc typo); SURFACE-2026-05-16-02 (low — perf flake); SURFACE-2026-05-12-02 (low — test-mission pollution); SURFACE-2026-04-19-01 (Phase 3 — bundle).
