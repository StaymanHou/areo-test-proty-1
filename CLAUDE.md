...
**Status (2026-05-12, post-WP14):** Phase 1 closed at the Chromium-only / operator-as-tester bar (WP1–WP9 + WP9.5 + WP9.6, 246/246 Vitest + 1/1 Playwright). Phase 2 arch revision (WP10) + β5 schema (WP10.5) + mission framework (WP11) + HUD (WP12) + free-flight close (WP13) + waypoint patrol (WP14) all shipped 2026-05-12 — 385/385 Vitest + 9/9 Playwright + tsc strict + build clean. Two mission types playable end-to-end with HUD + Escape-to-menu. Next: **WP14.5** (clAlphaDot tuning per SURFACE-2026-05-12-01 — unblocks high-energy patrols + WP15 + WP16), **WP15** (takeoff/landing, M), **WP16** (combat, L), **WP17** (Phase 2 verification). Open SURFACE items: **SURFACE-2026-05-12-01** (clAlphaDot tuning — new this session; gates sustained-throttle missions); **SURFACE-2026-05-11-04** (phugoid — partial; arch resolved at WP10.5, tuning at WP14.5); SURFACE-2026-05-11-02 (descending-glide; depends on phugoid); SURFACE-2026-04-19-01 (bundle size — Phase 3).
