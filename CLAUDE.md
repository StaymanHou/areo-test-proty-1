...
**Status (2026-05-12, post-WP12):** Phase 1 closed at the Chromium-only / operator-as-tester bar (WP1–WP9 + WP9.5 + WP9.6, 246/246 Vitest + 1/1 Playwright). Phase 2 arch revision (WP10) + β5 schema (WP10.5) + mission framework (WP11) + HUD (WP12) all shipped 2026-05-12 — 374/374 Vitest + 6/6 Playwright + tsc strict + build clean. HUD is live in-mission: alt/airspeed/throttle readouts, objective text, status banner, projection-ready waypoint arrow (WP14 will wire next-waypoint position). Next: **WP13** (free flight, XS — framework already validates the run pathway; could be small task or WBS mark-done), **WP14** (waypoint, S — first non-trivial mission, now unblocked by WP12), **WP15** (takeoff/landing, M), **WP16** (combat, L). Remaining open SURFACE items: **SURFACE-2026-05-11-04** (phugoid — addressed by D13 schema in WP10.5, tuning deferred to whichever mission first surfaces a level-cruise need); SURFACE-2026-05-11-02 (descending-glide; depends on phugoid); SURFACE-2026-04-19-01 (bundle size — Phase 3).
